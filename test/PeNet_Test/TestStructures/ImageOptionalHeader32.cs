...
namespace PeNet_Test.TestStructures
{
    public class ImageOptionalHeader32 : PEStructure, IImageOptionalHeader
    {
        ...
        public IValueType<uint> BaseOfData => new PropertyUInt(0x18, 0x99aabbcc);
        public IValueType<ulong> ImageBase => new PropertyULong(0x1c, 4, 0xddeeff00);
        ...
        public IValueType<ulong> SizeOfStackReserve => new PropertyULong(0x48, 4, 0x99aabbcc);
        public IValueType<ulong> SizeOfStackCommit => new PropertyULong(0x4c, 4, 0xddeeff00);
        public IValueType<ulong> SizeOfHeapReserve => new PropertyULong(0x50, 4, 0x11223344);
        public IValueType<ulong> SizeOfHeapCommit => new PropertyULong(0x54, 4, 0x55667788);
        public IValueType<uint> LoaderFlags => new PropertyUInt(0x58, 0x99aabbcc);
        public IValueType<uint> NumberOfRvaAndSizes => new PropertyUInt(0x5c, 0x00000004);
        public IValueType<IValueType<IImageDataDirectory>[]> DataDirectories => new PropertyDataDirectoryArray(0x60, 4*0x8, new[]
        {
